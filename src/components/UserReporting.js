    ...
    <section className={UR.userReports}>
        ...
        {/* <a style={{textDecoration:"none",color:"white"}} href="/UserReporting"> */}
          ...
          {/* <a style={{textDecoration:"none",color:"white"}} href="/WorkOrderReports"> */}
                  <div className={UR.woReports} onClick={toggleHandlerK2} style={{height:"60px",width:"60px",border:"2px solid rgba(247, 63, 8, 0.712)",borderRadius:"30px",marginLeft:"80px"}}><GiNotebook size={36} style={{marginTop:"10px",marginLeft:"3px"}}/></div> <br /> <p style={{paddingLeft:"50px",fontWeight:"600",color:"white"}} >Work Order Reports</p>
                  {/* </a> */}
            </div>  
          
          <div className={UR.report3}> 
           {/* <a style={{textDecoration:"none",color:"white"}} href="/DBRecord"> */}
                  <div className={UR.dbRecord} onClick={toggleHandlerK3} style={{height:"60px",width:"60px",border:"2px solid rgba(247, 63, 8, 0.712)",borderRadius:"30px",marginLeft:"80px"}}><SlNotebook size={34} style={{marginTop:"10px"}}/></div> <br /> 
                  <p style={{paddingLeft:"50px",fontWeight:"600",color:"white"}}>Digital Batch Record</p>
                  {/* </a> */}
          </div>
        ...
        {toggleK1?<TOReports />:toggleK2?<WorkOrderReports/>:toggleK3?<DBRecord />:null}
